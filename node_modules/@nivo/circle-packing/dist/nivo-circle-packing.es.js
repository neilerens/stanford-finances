import React, { useMemo, useCallback, createElement, Fragment, useRef, useEffect } from 'react';
...
var Circles = function Circles(_ref) {
  ...
  return React.createElement(React.Fragment, null, transition(function (transitionProps, node) {
...
var Labels = function Labels(_ref) {
  ...
  return React.createElement(React.Fragment, null, transition(function (transitionProps, label) {
    return React.createElement(component, {
      key: label.node.id,
      label: label.label,
      style: _objectSpread2(_objectSpread2({}, transitionProps), {}, {
...
var InnerCirclePacking = function InnerCirclePacking(_ref) {
  ...
  if (layers.includes('circles')) {
    layerById.circles = React.createElement(Circles, {
      key: "circles",
      nodes: zoomedNodes,
      borderWidth: borderWidth,
  ...
  if (enableLabels && layers.includes('labels')) {
    layerById.labels = React.createElement(Labels, {
      key: "labels",
      nodes: zoomedNodes,
      label: label,
      filter: labelsFilter,
...
var CirclePacking = function CirclePacking(_ref2) {
  ...
  return React.createElement(Container, {
    ...
    theme: theme
  }, React.createElement(InnerCirclePacking, Object.assign({
    isInteractive: isInteractive
  }, otherProps)));
};
...
var ResponsiveCirclePacking = function ResponsiveCirclePacking(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(CirclePacking, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
var CirclePackingHtml = function CirclePackingHtml(_ref2) {
  ...
  return React.createElement(Container, {
    ...
    motionConfig: motionConfig,
    theme: theme
  }, React.createElement(InnerCirclePackingHtml, Object.assign({
    isInteractive: isInteractive
  }, otherProps)));
};
...
var ResponsiveCirclePackingHtml = function ResponsiveCirclePackingHtml(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(CirclePackingHtml, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
var CirclePackingCanvas = function CirclePackingCanvas(_ref2) {
  ...
  return React.createElement(Container, {
    isInteractive: isInteractive,
    theme: theme
  }, React.createElement(InnerCirclePackingCanvas, Object.assign({
    isInteractive: isInteractive
  }, otherProps)));
};
...
var ResponsiveCirclePackingCanvas = function ResponsiveCirclePackingCanvas(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(CirclePackingCanvas, Object.assign({
      width: width,
      height: height
    }, props));
  });
