(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('d3-hierarchy'), require('lodash/cloneDeep'), require('lodash/sortBy'), require('@nivo/colors'), require('@nivo/tooltip'), require('react-spring')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', 'd3-hierarchy', 'lodash/cloneDeep', 'lodash/sortBy', '@nivo/colors', '@nivo/tooltip', 'react-spring'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.d3, global['lodash/cloneDeep'], global['lodash/sortBy'], global.nivo, global.nivo, global['react-spring']));
}(this, (function (exports, React, core, d3Hierarchy, cloneDeep, sortBy, colors, tooltip, reactSpring) { 'use strict';
